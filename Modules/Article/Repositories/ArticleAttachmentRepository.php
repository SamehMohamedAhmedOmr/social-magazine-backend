...
use Modules\Article\Entities\ArticleAttachment;
use Modules\Base\Repositories\Classes\LaravelRepositoryClass;

class ArticleAttachmentRepository extends LaravelRepositoryClass
{
    public function __construct(ArticleAttachment $model)
    {
        $this->model = $model;
    }
