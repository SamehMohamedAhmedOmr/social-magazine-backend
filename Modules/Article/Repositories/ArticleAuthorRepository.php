...
use Modules\Article\Entities\ArticleAuthors;
use Modules\Base\Repositories\Classes\LaravelRepositoryClass;

class ArticleAuthorRepository extends LaravelRepositoryClass
{
    public function __construct(ArticleAuthors $model)
    {
        $this->model = $model;
    }
