...
use Modules\Article\Entities\ArticleSelectedJudge;
use Modules\Base\Repositories\Classes\LaravelRepositoryClass;

class ArticleSelectedJudgeRepository extends LaravelRepositoryClass
{
    public function __construct(ArticleSelectedJudge $model)
    {
        $this->model = $model;
    }
