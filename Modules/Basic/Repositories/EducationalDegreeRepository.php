...
class EducationalDegreeRepository extends LaravelRepositoryClass
{
    public function __construct(EducationalDegree $educational_degree)
    {
        $this->model = $educational_degree;
    }
