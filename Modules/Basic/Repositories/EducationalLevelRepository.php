...
class EducationalLevelRepository extends LaravelRepositoryClass
{
    public function __construct(EducationalLevel $educational_level)
    {
        $this->model = $educational_level;
    }
