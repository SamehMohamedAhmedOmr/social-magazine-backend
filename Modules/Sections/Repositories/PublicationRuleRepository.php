...
use Modules\Sections\Entities\PublicationRules;

class PublicationRuleRepository extends LaravelRepositoryClass
{
    public function __construct(PublicationRules $publicationRules)
    {
        $this->model = $publicationRules;
    }
