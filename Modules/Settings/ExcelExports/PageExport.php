...
use Modules\Settings\Services\CMS\Exports\PageExportService;
use Modules\Settings\Services\CMS\PagesService;
use PhpOffice\PhpSpreadsheet\Worksheet\Worksheet;

class PageExport implements FromArray , WithHeadings, ShouldAutoSize, WithStyles, WithEvents
{
    ...
    {
        $data = ExcelExportHelper::prepareDataForExport(App::make(PagesService::class),
            App::make(PageExportService::class));
