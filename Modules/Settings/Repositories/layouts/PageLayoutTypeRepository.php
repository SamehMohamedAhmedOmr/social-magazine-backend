...
class PageLayoutTypeRepository extends LaravelRepositoryClass
{
    public function __construct(PageLayoutTypes $layoutTypes)
    {
        $this->model = $layoutTypes;
        $this->cache_key = 'layoutTypes';
    }
