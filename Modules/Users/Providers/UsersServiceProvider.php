...
class UsersServiceProvider extends ServiceProvider
{
    ...
    public function registerHelpers(){
        App::bind('UsersErrorsHelper', function () {
            return App::make(UsersErrorsHelper::class);
        });
    ...
    {
        $this->publishes([
            module_path('Users', 'Config/config.php') => config_path('users.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Users', 'Config/config.php'),
            'users'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('Users', 'Resources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('Users', 'Resources/lang'), 'users');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Users', 'Database/factories'));
        }
    }
