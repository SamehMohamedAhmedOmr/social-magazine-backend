...
use Modules\WareHouse\Services\CMS\Exports\OrderNoteExportService;
use Modules\WareHouse\Services\CMS\Order\OrderNotesService;
use PhpOffice\PhpSpreadsheet\Worksheet\Worksheet;

class OrderNoteExport implements FromArray , WithHeadings, ShouldAutoSize, WithStyles, WithEvents
{
    ...
    {
        $data = ExcelExportHelper::prepareDataForExport(App::make(OrderNotesService::class),
            App::make(OrderNoteExportService::class));
